    ...
    <SidebarProvider style={style as React.CSSProperties}>
      <div className="flex h-screen w-full bg-background overflow-hidden" dir="rtl">
        <main className="flex-1 flex flex-col min-w-0 relative overflow-hidden bg-background">
          <header className="h-16 border-b flex items-center justify-between px-4 md:px-6 bg-background/80 backdrop-blur-md sticky top-0 z-30">
        ...
        <Sidebar collapsible="icon" side="right" className="border-e bg-sidebar dark:bg-sidebar">
              ...
              {navItems.map((item) => (
                <SidebarMenuItem key={item.href}>
                  <SidebarMenuButton
                    ...
                    tooltip={item.label}
                    className="h-11 px-4 rounded-lg transition-all data-[active=true]:bg-sidebar-accent data-[active=true]:text-sidebar-accent-foreground hover:bg-sidebar-accent/50 hover:text-sidebar-accent-foreground text-right"
                  >
          ...
          <SidebarFooter className="p-4 border-t bg-sidebar dark:bg-sidebar">
            <div className="flex flex-col gap-4">
              <div className="flex items-center gap-3 px-2 group-data-[collapsible=icon]:px-0 text-sidebar-foreground text-right">
