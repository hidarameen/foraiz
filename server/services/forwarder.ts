...
2. إذا لم تخالف الرسالة أياً من القواعد المذكورة أدناه بشكل صريح، فيجب أن يكون القرار "ALLOW".
3. في وضع "Blacklist": اسمح بكل شيء (ALLOW) "إلا" إذا وجد تعارض صريح مع إحدى القواعد.
4. في وضع "Whitelist": امنع كل شيء (BLOCK) "إلا" إذا كانت الرسالة تطابق إحدى القواعد صراحة.
5. "هام جداً": عند تقييم قاعدة طول النص (مثلاً 100 كلمة)، اعتمد على "عدد كلمات الرسالة" المذكور أعلاه (${wordCount} كلمة) ولا تحسب كلمات هذا البرومبت أو القواعد.
